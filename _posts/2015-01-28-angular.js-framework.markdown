...
<div class="row">
        ...
        <div class="col-lg-4 col-sm-12 text-center"><img class="img-circle img-responsive img-center" src="{{ site.baseurl }}/img/9k=.jpg" alt="Lucas Gatsas">  <h3>Helen V. Holmes
...
<a href="#">
    <img src="{{ site.baseurl }}/img/concepts-startup.png" alt="Lucas Gatsas" style="width:50%">
</a> 
