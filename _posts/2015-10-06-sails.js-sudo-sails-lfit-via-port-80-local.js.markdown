...
Take your port with this small code <code>  port: process.env.PORT || 80, </code> 
<br>

Now go ahead with the <code> local.js </code> like in the description in the sails.js document! 
