...
Here is a small preview of our Current Web App. The Workflow. We use The Realtime MVC Framework from <a href="http://sailsjs.org/#!/documentation/concepts">sails.js</a> And the <a href="http://backbonejs.org/">backbone.js</a> for the Front End. 
